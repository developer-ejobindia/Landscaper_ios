...
public class Login_data: NSObject, NSCoding {
    ...
    private struct SerializationKeys {
        ...
        //static let service_count = "service_count"
    }
    ...
    //public var service_count: NSInteger?
    ...
    public required init(json: JSON) {
       data1 = Details(json: json[SerializationKeys.data1])
        ...
        //service_count = json[SerializationKeys.service_count].intValue
    }
    ...
    required public init(coder aDecoder: NSCoder) {
       self.data1 = aDecoder.decodeObject(forKey: SerializationKeys.data1) as? Details
        ...
        //self.service_count = aDecoder.decodeObject(forKey: SerializationKeys.service_count) as? NSInteger
    }
    ...
    public func encode(with aCoder: NSCoder) {
        ...
        //aCoder.encode(service_count, forKey: SerializationKeys.service_count)
    }
