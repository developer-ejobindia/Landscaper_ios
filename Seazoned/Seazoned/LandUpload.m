...
@interface LandUpload ()

@end

@implementation LandUpload
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    //[self editdata];
      ...
      [self performSelector:@selector(editdata) withObject:nil afterDelay:3.0];
}
...
-(void)editdata
{
    ...
    //NSString *url = [NSString stringWithFormat:@"http://192.168.1.2:8080/dev/seazonedapp/public/api/upload-landscaper-images?"];
    
  //  "http://seazoned.com/api"
    
//    NSString *url = [NSString stringWithFormat:@"http://103.230.103.142:8080/dev/seazonedapp/public/api/upload-landscaper-images?"];
    
    
    
        NSString *url = [NSString stringWithFormat:@"http://seazoned.com/api/upload-landscaper-images?"];
