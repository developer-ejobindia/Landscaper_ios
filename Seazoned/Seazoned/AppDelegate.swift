...
//        topWindow.rootViewController?.present(alert, animated: true, completion: { _ in })
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any]) {
       ...
       // notlst
        ...
        let obj = mainStoryboard.instantiateViewController(withIdentifier: "notlst") as! NotificationList
...
//                    let mainStoryboard = UIStoryboard(name: "Main", bundle: nil)
//
//                    let obj = mainStoryboard.instantiateViewController(withIdentifier: "lg") as! Login
//
...
//                rootViewController.pushViewController(obj, animated: true)
     ...
     //   print("mmmmm \(notification)")
        ...
        if status_id=="3" {
            ...
            SANotificationView.showSABanner(title: "Seazoned", message: body, image: #imageLiteral(resourceName: "lm"),  showTime: 3)
