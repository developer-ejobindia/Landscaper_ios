...
//    "active": 1
   ...
   static let user_type = "user_type"
    ...
    public func dictionaryRepresentation() -> [String: Any] {
        ...
        if let value1 = user_id { dictionary[SerializationKeys.user_id] = value1 }
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.user_id = aDecoder.decodeObject(forKey: SerializationKeys.user_id) as? String
     
    }
    
    public func encode(with aCoder: NSCoder) {
        aCoder.encode(first_name, forKey: SerializationKeys.first_name)
        aCoder.encode(user_id, forKey: SerializationKeys.user_id)
